...
def voice_index(request):
    ...
    fields_df = ['id', 'id_number__number', 'id_item__client', 'id_number__id', 'id_item__item_id', 'id_number__login', 'id_number__password', 'id_number__number_qrcode', 'id_item__days', 'id_number__activation_date', 'call_status']
