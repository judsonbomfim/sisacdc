...
def sims_in_orders():
    ...
    for ord in orders:
        ...
        if ord.id_sim != None:
            ...
            # ESCOLHER OPERADORA
            if (product_i == 'chip-internacional-europa' and countries_i == False) or product_i == 'chip-internacional-europa-plus' or product_i == 'chip-internacional-america-do-sul':
                operator_i = 'TC'
